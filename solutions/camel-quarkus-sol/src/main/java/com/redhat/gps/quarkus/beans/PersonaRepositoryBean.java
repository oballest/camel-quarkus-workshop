...
public class PersonaRepositoryBean {
    ...
    public Persona getPersonaById(@Header("idPersona") Integer id){
        logger.info("Consultando persona con id "+id);
        return repository.get(id);
    }

    public void insertPersona(@Body Persona persona){
    ...
    public void deletePersona(@Header("idPersona") Integer id){
